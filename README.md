...
- Export: copy the originals of your selection (or filtered view) to any folder — bottom-right button or `Ctrl+E`, cross-platform native folder picker; scope menu picks all files, RAW only, or companion JPEGs only
